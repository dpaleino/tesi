...
\begin{figure}[p!]
\subfloat[][]
   {\label{fig:steiner_traslazione}\fbox{\includegraphics[width=.45\textwidth]{./images/steiner_incisivo_traslazione.jpg}}} \quad
\subfloat[][]
...
\begin{minipage}{.44\textwidth}
 \centering
 \fbox{\includegraphics[width=.95\textwidth]{./images/steiner_interincisale.jpg}}
