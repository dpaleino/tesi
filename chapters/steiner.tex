...
\begin{figure}[p!]
\subfloat[][]
   {\label{fig:steiner_sna}\fbox{\includegraphics[width=.45\textwidth]{./images/steiner_sna.jpg}}} \quad
\subfloat[][]
   {\label{fig:steiner_snb}\fbox{\includegraphics[width=.45\textwidth]{./images/steiner_snb.jpg}}}
 \centering
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=.75\textwidth]{./images/steiner_linea_s.jpg}}
