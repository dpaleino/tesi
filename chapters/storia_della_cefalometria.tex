...
\centering
\subfloat[][]
   {\includegraphics[width=.35\textwidth]{./images/sariputra_buddha_front.png}} \quad
\subfloat[][]
   {\includegraphics[width=.35\textwidth]{./images/sariputra_buddha_side.png}}
...
\begin{SCfigure}[][h!]
 \centering
 \fbox{\includegraphics[width=.7\textwidth]{./images/camper-crani.jpg}}
